...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="page-header">
                ...
                <p class="mb-0 text-muted">Kelola dan perbarui informasi supplier</p>
            </div>
                ...
                <form action="?m=supplier&s=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group-custom">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="nama_sup" 
                                           value="<?php echo $r['nama_sup']; ?>" 
                                           placeholder="Masukkan nama supplier"
                                           required>
                                </div>
                                <div class="form-text">Nama lengkap supplier atau perusahaan</div>
                            </div>
                        </div>
                            ...
                            <div class="input-group-custom">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-icon" 
                                           name="kontak_sup" 
                                           value="<?php echo $r['kontak_sup']; ?>" 
                                           placeholder="Masukkan kontak supplier"
                                           required>
                                </div>
                                <div class="form-text">Nomor kontak utama supplier</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group-custom">
                                <label class="form-label">
                                    <i class="fas fa-mobile-alt me-1"></i>Telepon Supplier
                                </label>
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-icon" 
                                           name="telepon_sup" 
                                           value="<?php echo $r['telepon_sup']; ?>" 
                                           placeholder="Masukkan nomor telepon"
                                           required>
                                </div>
                                <div class="form-text">Nomor telepon alternatif</div>
                            </div>
                        </div>
                            ...
                            <div class="input-group-custom">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-icon" 
                                           name="alamat_sup" 
                                           value="<?php echo $r['alamat_sup']; ?>" 
                                           placeholder="Masukkan alamat lengkap"
                                           required>
                                </div>
                                <div class="form-text">Alamat lengkap supplier</div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            const telepon = document.querySelector('input[name="telepon_sup"]').value;
            const phoneRegex = /^[0-9+\-\s]+$/;
            
            if (!phoneRegex.test(telepon)) {
                e.preventDefault();
                alert('Nomor telepon hanya boleh berisi angka, tanda +, -, dan spasi!');
