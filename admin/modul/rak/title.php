...
<head>
    ...
    <title><?php echo isset($judul) ? $judul : 'Gudangku - Data Rak'; ?></title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="?m=rak&s=awal" class="nav-link active">
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle mb-0">Kelola data rak penyimpanan barang</p>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead>
                                <tr>
                                    <th><i class="fas fa-hashtag me-2"></i>ID Rak</th>
                                    <th><i class="fas fa-tag me-2"></i>Nama Rak</th>
                    ...
                    <nav class="mt-4">
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php echo ($halaman <= 1) ? 'disabled' : ''; ?>">
                                <a class="page-link" <?php if($halaman > 1){ echo "href='?m=rak&s=awal&halaman=$previous'"; } ?>>
                            ...
                            <?php for($x=1; $x<=$total_halaman; $x++): ?>
                                <li class="page-item <?php echo ($x == $halaman) ? 'active' : ''; ?>">
                                    <a class="page-link" href="?m=rak&s=awal&halaman=<?php echo $x; ?>">
                                        <?php echo $x; ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
                            ...
                            <li class="page-item <?php echo ($halaman >= $total_halaman) ? 'disabled' : ''; ?>">
                                <a class="page-link" <?php if($halaman < $total_halaman) { echo "href='?m=rak&s=awal&halaman=$next'"; } ?>>
    ...
    <div class="modal fade" id="addRakModal" tabindex="-1" aria-labelledby="addRakModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="?m=rak&s=simpan" method="POST" enctype="multipart/form-data" id="formTambah">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="nama_rak" class="form-label">
                                <i class="fas fa-tag me-1"></i>Nama Rak
                            </label>
                            <input type="text" 
                                   class="form-control" 
                                   id="nama_rak" 
                                   ...
                                   required>
                            <div class="form-text">Contoh: Rak A1, Rak Elektronik, dll.</div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('addRakModal').addEventListener('shown.bs.modal', function () {
            document.getElementById('nama_rak').focus();
        });
